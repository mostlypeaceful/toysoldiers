...
namespace Sig
{
	...
	tMayaMatEdWindow::tMayaMatEdWindow( wxWindow* parent )
		: tMatEdMainWindow( parent, mActionStack, ToolsPaths::fGetSignalRegistryKeyName( ) + "\\MayaMatEd", true, false, true )
		, mSelectedMaterial( 0 )
	{
		// store maya's hwnd
	...
	void tMayaMatEdWindow::fUpdateDevice( )
	{
		...
		{
			log_warning( "Creating material preview WITHOUT maya d3d device!" );
