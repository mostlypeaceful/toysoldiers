...
// on the Xbox 360. It can be used as a standalone implementation of the 
...
#define XBOX360_DEVICE_BLOCKING_NAME       (L"360 Blocking")	// Device blocking name.
    ...
    )
{
	...
	AKPLATFORM::SafeStrCpy( out_deviceDesc.szDeviceName, XBOX360_DEVICE_BLOCKING_NAME, AK_MONITOR_DEVICENAME_MAXLENGTH );
