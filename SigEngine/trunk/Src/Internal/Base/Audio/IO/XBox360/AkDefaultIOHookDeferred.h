...
public:
	...
	// On the Xbox 360, ::CreateFile() can take a significant amount of time, therefore
	// the default value for in_bAsyncOpen is true: deferred file opening is 
	// done when possible.
	AKRESULT Init(
...
protected:
	...
	// If you release overlapped objects from your own thread, this lock is mandatory.
