...
namespace Sig { namespace Win32Util
{
	...
	///
	/// \brief Launch a process, wait for it to exit and return its output
	base_export b32 fLaunchProcessAndCaptureOutput( std::string cmdLine, std::string& output );
