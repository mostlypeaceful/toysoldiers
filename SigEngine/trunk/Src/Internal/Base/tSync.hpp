...
namespace Sig
{
	...
	{
		declare_singleton_define_own_ctor_dtor( tSync );
	public:
	...
	public:
		...
		{
			sig_make_stringstreamable( tSyncStrPtr, ( fCStr( ) ? fCStr( ) : "(null)" ) );
		private:
	...
	private:
		...
		/// \class tFrameHeader
		/// \brief 
		class tFrameHeader : public tRefCounterCopyable
		{
	...
	private:
		...
		Threads::LocalStorage::tLocalStorageHandle mFrameHeaderTLS;
