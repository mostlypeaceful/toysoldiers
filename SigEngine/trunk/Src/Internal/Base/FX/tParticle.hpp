...
namespace Sig { namespace FX
{
	...
	class base_export tParticle
	{
		...
		debug_watch( tParticle );
	public:

		tParticle( f32 lifetime, f32 curLife, f32 yaw, f32 cutout, const Math::tVec2f& scale, const Math::tVec3f& pos, const Math::tVec3f& dir, const Math::tVec4f& color )
			: mLifetime( lifetime )
