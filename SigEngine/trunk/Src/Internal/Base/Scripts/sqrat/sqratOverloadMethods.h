...
//    Dec 6, 2011:
//
// VS2011 can convert pointers to const member functions implicitly, but 2008 can't seem to.
// Added SqOverloadFunc overloads so our stuff compiles.
...
namespace Sqrat {
	...
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4, class A5>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4, A5) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4, A5, A6) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4, A5, A6, A7) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4, A5, A6, A7, A8) ) {
		return &SqOverload<R>::Func;
	}

	template <class C, class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8, class A9>
	inline SQFUNCTION SqOverloadFunc(R (C::*method)(A1, A2, A3, A4, A5, A6, A7, A8, A9) ) {
		return &SqOverload<R>::Func;
	}
	// End of additional SqOverloadFunc overloads... at the time of writing anyways.
