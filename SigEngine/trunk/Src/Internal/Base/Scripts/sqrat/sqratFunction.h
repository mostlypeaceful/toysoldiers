...
namespace Sqrat {
	...
	public:
        ...
        R fDoEvaluate( )
        {
            sq_call(vm, callArgCount+1, true, ErrorHandling::IsEnabled());
            R ret = Var<R>(vm, -1).Value();
            sq_pop(vm, 2);
            return ret;
        }
        ...
        void fDoExecute( )
        {
            sq_call(vm, callArgCount+1, false, ErrorHandling::IsEnabled());
            sq_pop(vm, 1);
        }
