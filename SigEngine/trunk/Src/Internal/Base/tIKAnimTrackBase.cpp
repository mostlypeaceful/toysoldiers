...
namespace Sig { namespace Anim
{
	namespace
	{
		...
		tAnimTrackPtr fRemoveIKTracks( Anim::tAnimatedSkeleton* stack, u32 channel, u32 group )
		{
	...
	void tIKAnimTrackDesc::fExportScriptInterface( tScriptVm& vm )
	{
		...
		{
			Sqrat::DerivedClass< tIKAnimTrackDesc, tAnimTrackDesc, Sqrat::NoConstructor > classDesc( vm.fSq( ) );
			classDesc
