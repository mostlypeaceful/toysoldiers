...
namespace Sig
{
	...
	template<>
	inline b32 fOctreeIntersectAabbWithVolume<Math::tFrustumf>( const Math::tAabbf& aabb, const Math::tFrustumf& v, b32* aabbWhollyContained )
	{
	...
	template<>
	inline b32 fOctreeIntersectAabbWithVolume<Math::tAabbf>( const Math::tAabbf& aabb, const Math::tAabbf& v, b32* aabbWhollyContained )
	{
	...
	template<>
	inline b32 fOctreeIntersectAabbWithVolume<Math::tObbf>( const Math::tAabbf& aabb, const Math::tObbf& v, b32* aabbWhollyContained )
	{
	...
	template<>
	inline b32 fOctreeIntersectAabbWithVolume<Math::tSpheref>( const Math::tAabbf& aabb, const Math::tSpheref& v, b32* aabbWhollyContained )
	{
