...
{
	class base_export tPhysical : public tRefCounter
	{
		debug_watch( tPhysical );
		declare_uncopyable( tPhysical );
...
{
	class base_export tStandardPhysics : public Logic::tPhysical
	{
		declare_uncopyable( tStandardPhysics );
