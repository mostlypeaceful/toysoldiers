...
namespace Sig
{
	...
	void tConsoleApp::fCreateConsole( const char* welcomeText, b32 isRealConsoleApp )
	{
		...
		// Redirect unbuffered STDOUT to the console: http://www.halcyon.com/~ast/dload/guicon.htm
		long hConsole = _open_osfhandle(reinterpret_cast<int>( mOutputHandle ), _O_TEXT);
