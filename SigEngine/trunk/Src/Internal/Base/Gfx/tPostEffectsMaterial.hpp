...
namespace Sig { namespace Gfx
{
	struct base_export tPostEffectsRenderVertex
	{
		...
		inline tPostEffectsRenderVertex( const Math::tVec3f& p ) : mP( p ) { }
	};
	...
	public:
		...
		enum tPShaders
		{
			...
			cPShaderBlendUsingDepthAndFog,
			cPShaderSaturation,
			cPShaderFilmGrain,
			cPShaderTransform,
			cPShaderBlendUsingDepthAndOverlay,
			cPShaderBlendUsingDepthAndOverlayAndFog,
			cPShaderFilterHighPass,
			cPShaderFXAA, // anti-aliasing technique provided by nvidia

			cPShaderBlendUsingDepthAndSaturate,
			cPShaderBlendUsingDepthAndFogAndSaturate,
			cPShaderBlendUsingDepthAndOverlayAndSaturate,
			cPShaderBlendUsingDepthAndOverlayAndFogAndSaturate,
		...
		enum tPSConstants
		{
			...
			cPSRgbaTint3,
			cPSRgbaBlend,
			cPSTargetDepthValues,
			cPSSaturation,
			cPSProjToView = cPSSaturation, //hijacks the above unused constant for some shaders and needs 4 unused ones below it
			cPSFilmGrainFlicker = cPSProjToView + 4,
			cPSFilmGrainOffsets0,
			cPSFilmGrainOffsets1,
			cPSContrast,
			cPSTransformCutoff,
			cPSTransformAdd,
			cPSTransformMul,
			cPSFogParams,
			cPSFogColor,
			cPSVerticalFogParams,
			cPSVerticalFogColor,
			cPSNearFarPlanes,
			cPSSampleOffsets = cPSNearFarPlanes, // existing overlap
			cPSProjToWorld, // needs 4 unused ones below it
		};
	...
	public:
		...
		Math::tVec4f			mRgbaTint2;
		Math::tVec4f			mRgbaTint3;
		...
		Math::tVec4f			mTransformCutOff;
		Math::tVec4f			mTransformAdd;
		Math::tVec4f			mTransformMul;
		Math::tVec2f			mBlurScale;
