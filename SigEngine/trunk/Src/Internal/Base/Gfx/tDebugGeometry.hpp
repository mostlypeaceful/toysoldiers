...
namespace Sig { namespace Math { class tConvexHull; class tCapsule; class tCylinder; } } // not part of Math.hpp
...
namespace Sig { namespace Gfx
{
	...
	public:
		...
		void fRenderOnce( const Math::tCylinder& circle, u32 numSegments, const Math::tVec4f& rgba );
		...
		void fRenderOnce( const Math::tConvexHull& hull, const Math::tMat3f& xform, const Math::tVec4f& rgba );
		void fRenderOnce( const Math::tCapsule& capsule, const Math::tVec4f& rgba );
		void fRenderOnce( const Math::tCylinder& cylinder, const Math::tVec4f& rgba );
	...
	public:
		...
		inline void fRenderOnce( const Math::tCylinder& circle, u32 numSegments, const Math::tVec4f& rgba ) { }
		...
		inline void fRenderOnce( const Math::tConvexHull& hull, const Math::tMat3f& xform, const Math::tVec4f& rgba ) { }
		inline void fRenderOnce( const Math::tCapsule& capsule, const Math::tVec4f& rgba ) { }
		inline void fRenderOnce( const Math::tCylinder& cylinder, const Math::tVec4f& rgba ) { }
