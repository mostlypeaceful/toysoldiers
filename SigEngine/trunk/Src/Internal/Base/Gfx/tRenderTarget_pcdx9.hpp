...
namespace Sig { namespace Gfx
{
	...
	public:
		tRenderTarget( const tDevicePtr& device, u32 width, u32 height, b32 isDepth, tFormat format, u32 multiSamplePower = 0, b32 lockable = false );
		tRenderTarget( IDirect3DSurface9* rt, u32 width, u32 height, b32 isDepth, tFormat format, u32 multiSamplePower = 0 );
		~tRenderTarget( );
