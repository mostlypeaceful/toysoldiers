...
namespace Sig { namespace Gfx
{
	...
	{
		fGenerate( mGridLinesPerHalfAxis, mMinorIncrement, mMajorIncrement, mLastX, mLastZ );
	}

	void tSolidColorGrid::fResetDeviceObjects( 
		...
		const tIndexBufferVRamAllocatorPtr& indexAllocator )
	{
		...
		tSolidColorLines::fResetDeviceObjects( device, material, geometryAllocator, indexAllocator );
	}
