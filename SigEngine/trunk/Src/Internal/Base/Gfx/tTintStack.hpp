...
namespace Sig { namespace Gfx
{
	...
	class base_export tTintEntry : public tRefCounter
	{
	public:
	...
	class base_export tSolidTint : public tTintEntry
	{
	public:
	...
	class base_export tFlashingTint : public tTintEntry
	{
	public:
