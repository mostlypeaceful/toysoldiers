...
namespace Sig
{
	...
	/// \class tVoice
	/// \brief 
	class base_export tVoice : public tUncopyable, public tRefCounter
	{
	public:
		...
		static const u32 cMaxRemoteTalkers;
	...
	public:
		...
		b32 fIsLocalTalking( u32 localHwIndex );
		b32 fIsRemoteTalking( tPlatformUserId userId );
	...
	private:
		...
		static const u32 cChatPacketSize = 1;
