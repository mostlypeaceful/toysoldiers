...
#	define declare_reflector_data( ) \
	...
	/// These different names are picked up by the code preprocessor. otherwise they result in the same data members.
#	define declare_reflector( ) declare_reflector_data( )

	/// The intention of explicit is that it will not be automatically processed and the reflection will be managed by the user.
#	define declare_explicit_reflector( ) declare_reflector_data( )
...
#define define_dynamic_cast_base_own_debugtypename_no_static_cast( className ) \
	public: \
...
#define define_dynamic_cast_base_own_debugtypename( className ) \
	define_dynamic_cast_base_own_debugtypename_no_static_cast( className ) \
	static_cast_func( )

#define define_dynamic_cast_base_no_static_cast( className ) \
	define_dynamic_cast_base_own_debugtypename_no_static_cast( className ) \
	public: \
		debug_type_name( className ) 

#define define_dynamic_cast_base( className ) \
	define_dynamic_cast_base_own_debugtypename( className ) \
	public: \
		debug_type_name( className ) 

#define define_dynamic_cast_own_debugtypename( className, baseClassName ) \
	public: \
		using baseClassName::fDynamicCast; \
...
#define define_dynamic_cast( className, baseClassName ) \
	define_dynamic_cast_own_debugtypename( className, baseClassName ) \
	public: \
		debug_type_name( className )
