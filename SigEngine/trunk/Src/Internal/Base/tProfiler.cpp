...
namespace Sig
{
	...
	{
		{
			Memory::tHeapStacker cStacker( &Memory::tDebugMemoryHeap::fInstance( ) );
		...
		fAddMemCategory( cProfileMemVramSystem,			tMemCategory( tStringPtr( "Sys VRAM - Other" ) ) );
		fAddMemCategory( cProfileMemVramSysTextures,	tMemCategory( tStringPtr( "Sys VRAM - Frame Buffers" ) ) );
		fAddMemCategory( cProfileMemVramSysGeom,		tMemCategory( tStringPtr( "Sys VRAM - Geometry" ) ) );
		fAddMemCategory( cProfileMemVramSysShader,			tMemCategory( tStringPtr( "Sys VRAM - Shader" ) ) );
		fAddMemCategory( cProfileMemTexture,			tMemCategory( tStringPtr( "VRAM Texture" ) ) );
		fAddMemCategory( cProfileMemGeometry,			tMemCategory( tStringPtr( "VRAM Geometry" ) ) );
		fAddMemCategory( cProfileMemFui,				tMemCategory( tStringPtr( "VRAM Fui" ) ) );
		fAddMemCategory( cProfileMemMovie,				tMemCategory( tStringPtr( "VRAM Movie" ) ) );
		fAddMemCategory( cProfileMemGroundCover,		tMemCategory( tStringPtr( "VRAM GroundCover" ) ) );
		...
		fAddPerfCategory( cProfilePerfOnTickCanvas,		tPerfCategory( tStringPtr( "CanvasTick" )			, tStringPtr( "Render" ), 1 ) );
		fAddPerfCategory( cProfilePerfOnRenderCanvas,	tPerfCategory( tStringPtr( "CanvasRender" )			, tStringPtr( "Render" ), 1 ) );
		fAddPerfCategory( cProfilePerfOnTickFUI,		tPerfCategory( tStringPtr( "FUITick" )			, tStringPtr( "Render" ), 1 ) );
		fAddPerfCategory( cProfilePerfRenderFUI,		tPerfCategory( tStringPtr( "FUIRender" )		, tStringPtr( "Render" ), 1 ) );


		fAddPerfCategory( cProfilePerfPhysicsTotal,				tPerfCategory( tStringPtr( "Total" )	, tStringPtr( "Physics" ), 1 ) );
		fAddPerfCategory( cProfilePerfPhysicsCollisionPurge,	tPerfCategory( tStringPtr( "Purge" )	, tStringPtr( "Physics" ), 1, true ) );
		fAddPerfCategory( cProfilePerfPhysicsCollisionTest,		tPerfCategory( tStringPtr( "Test" )	, tStringPtr( "Physics" ), 1, true ) );
		fAddPerfCategory( cProfilePerfPhysicsCollisionResolve,	tPerfCategory( tStringPtr( "Resolve" )	, tStringPtr( "Physics" ), 1, true ) );
		fAddPerfCategory( cProfilePerfPhysicsCollisionMaintain,	tPerfCategory( tStringPtr( "Maintain" )	, tStringPtr( "Physics" ), 1, true ) );
		fAddPerfCategory( cProfilePerfPhysicsRigidBodyStep,		tPerfCategory( tStringPtr( "RigidBody" )	, tStringPtr( "Physics" ), 1, true ) );
		fAddPerfCategory( cProfilePerfPhysicsContraintStep,		tPerfCategory( tStringPtr( "Constraint" )	, tStringPtr( "Physics" ), 1, true ) );

		fAddPerfCategory( cProfilePerfNetworkTotal, tPerfCategory( tStringPtr( "Total" ), tStringPtr( "Network" ), 1 ) );
		fAddPerfCategory( cProfilePerfNetworkService, tPerfCategory( tStringPtr( "Service" ), tStringPtr( "Network" ), 1, true ) );
		fAddPerfCategory( cProfilePerfNetworkOnReceive, tPerfCategory( tStringPtr( "OnReceive" ), tStringPtr( "Network" ), 1, true ) );
		fAddPerfCategory( cProfilePerfNetworkSend, tPerfCategory( tStringPtr( "Send" ), tStringPtr( "Network" ), 1, true ) );
		fAddPerfCategory( cProfilePerfNetworkSearch, tPerfCategory( tStringPtr( "Search" ), tStringPtr( "Network" ), 1, true ) );
		fAddPerfCategory( cProfilePerfNetworkVoice, tPerfCategory( tStringPtr( "Voice" ), tStringPtr( "Network" ), 1, true ) );
	}
	tProfiler::~tProfiler( )
	{
		fShutdown( );
