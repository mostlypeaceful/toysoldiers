...
namespace Sig
{
	...
	public:
		...
		public:
			...
			inline explicit tRecvBuffer( byte* buffer=0, u32 bytesAllocated=0, b32 isGpu = false )
				: mBuffer( buffer )
			...
			inline b32		fIsGpuMem( ) const { return mIsGpuMem; }
	...
	private:
		...
		u32				mFileSize;
		tState volatile mState;
		b32				mOwnsFile;
		tReadParams		mReadParams;
	public:
		tFilePathPtr	mFileName;
		u32				mFileOffset; //Should always be 0 unless loading from a sacml
	private:
	...
	public:
		...
		tAsyncFileReaderPtr fSpawnChild( u32 rawFileOffset ) const;
