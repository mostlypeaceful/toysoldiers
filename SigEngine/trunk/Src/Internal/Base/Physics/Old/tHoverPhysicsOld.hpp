#ifndef __tHoverPhysicsOld__
#define __tHoverPhysicsOld__
...
namespace Sig { namespace PhysicsOld
{
	...
	////////////////////// - Logic Component - /////////////////////////////
	class tHoverPhysics : public Physics::tStandardPhysics
	{
		define_dynamic_cast( tHoverPhysics, Physics::tStandardPhysics );
	...
	public:
		...
		void fClearContacts( );
		void fAddContactPt( f32 dt, const tContactPoint& cp );
		Math::tVec3f fComputeContactResponse( const tContactPoint& cp, f32 mass );
