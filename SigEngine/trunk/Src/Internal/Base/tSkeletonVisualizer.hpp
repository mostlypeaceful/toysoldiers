...
namespace Sig
{
	...
	public:
		...
		void fSetSkeleton( const Anim::tAnimatedSkeletonPtr& animatedSkel );
	...
	private:
		void fGenerateRenderables( const Anim::tAnimatedSkeleton::tBoneLine& root );
		void fUpdateRenderables( const Anim::tAnimatedSkeleton::tBoneLine& root );
	};
