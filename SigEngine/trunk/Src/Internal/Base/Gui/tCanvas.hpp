...
namespace Sig { namespace Gui
{
	...
	public:
		...
		const Math::tRect&		fLocalRect( ) const { return mLocalXform.mRect; }
		const Math::tRect&		fWorldRect( ) const { return mWorldXform.mRect; }
		...
		b32						fContainsWorldPoint( const Math::tVec2f& pt ) const;
	...
	protected:
		void fSetBounds( const Math::tRect& rect );
	...
	class base_export tCanvasPtr : public tScriptOrCodeObjectPtr<tCanvas>
	{
	public:
		tCanvasPtr( ) { }
	...
	class base_export tCanvasFrame : public tCanvas
	{
