...
namespace Sig { namespace Gui {
	...
	//------------------------------------------------------------------------------
	class base_export tSaveUI : public tScriptedControl 
	{
	public:
		...
		class base_export tGameStorageSaveInstance : public tSaveInstance
		{	
		private:
	...
	public:
		...
		explicit tSaveUI( const tResourcePtr& scriptResource, tCanvasFrame& frame );
		virtual ~tSaveUI( );
