...
namespace Sig { namespace Input
{
	...
	const tKeyboard::tButton tKeyboard::cButtonMinus		= 0;//VK_SUBTRACT;			/* - on main keyboard */
	const tKeyboard::tButton tKeyboard::cButtonEquals		= 0;//VK_ADD;
	...
	const tKeyboard::tButton tKeyboard::cButtonPause		= ~0;					/* Pause/break key */
