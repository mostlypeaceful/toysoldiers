...
namespace Sig { namespace Input
{
	...
	const tKeyboard::tButton tKeyboard::cButtonLWin			= ~0;					/* Left Windows key */
	const tKeyboard::tButton tKeyboard::cButtonRWin			= ~0;					/* Right Windows key */
	const tKeyboard::tButton tKeyboard::cButtonPause		= VK_PAUSE;				/* Pause/break key -- untested, feel free to replace with ~0 */
