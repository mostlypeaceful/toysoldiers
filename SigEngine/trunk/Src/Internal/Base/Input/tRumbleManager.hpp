...
namespace Sig { namespace Input
{
	...
	class base_export tRumbleManager
	{
	public:
		tRumbleManager( );
		...
		// Set this to true to continue advancing rumble manager but not post rumble values
		void fSetUserDisabled( b32 disabled ) { mUserDisabled = disabled; }
		b32 fUserDisabled( ) const { return mUserDisabled; }
