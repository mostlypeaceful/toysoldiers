...
namespace Sig { namespace Dx360Util
{
	...
	toolsxdk_export f32 fConvertHalfToFloat( u16 h );
	toolsxdk_export Math::tVec2f fConvertHalfToVec2f( const Math::tVector2<u16>& h );
	toolsxdk_export Math::tVec3f fConvertHalfToVec3f( const Math::tVector4<u16>& h );
	toolsxdk_export Math::tVec4f fConvertHalfToVec4f( const Math::tVector4<u16>& h );
