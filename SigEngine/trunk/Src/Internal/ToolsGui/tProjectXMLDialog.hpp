...
namespace Sig
{
	...
	protected:
		...
		void fOnAddAIFlag( wxCommandEvent& event );
		void fOnRemoveAIFlag( wxCommandEvent& event );
		void fOnRenameAIFlag( wxCommandEvent& event );
