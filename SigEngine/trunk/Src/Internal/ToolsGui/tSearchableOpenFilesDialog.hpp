...
namespace Sig
{
	...
	public:
		tSearchableOpenFilesDialog( wxWindow* parent, tWxDirectoryBrowser* browser = 0, s64 listBoxStyleFlags = 0 );
		explicit tSearchableOpenFilesDialog( wxWindow* parent, const tFilePathPtr& resFolder, s64 listBoxStyleFlags = 0 );
	...
	private:
		...
		void fCommonCtor( s64 listBoxStyleFlags = 0 );
