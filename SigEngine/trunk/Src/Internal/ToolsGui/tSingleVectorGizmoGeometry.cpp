...
#include "tSingleVectorGizmoGeometry.hpp"

namespace Sig
{
	tSingleVectorGizmoGeometry::tSingleVectorGizmoGeometry( 
	...
	void tSingleVectorGizmoGeometry::fOnDeviceReset( Gfx::tDevice* device )
	{
		fGenerate( );
	}

	void tSingleVectorGizmoGeometry::fGenerate( )
	{
