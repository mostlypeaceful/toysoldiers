...
namespace Sig
{
	tTranslationGizmoGeometry::tTranslationGizmoGeometry( 
	...
	void tTranslationGizmoGeometry::fOnDeviceReset( Gfx::tDevice* device )
	{
		fGenerate( );
	}

	void tTranslationGizmoGeometry::fGenerate( )
	{
