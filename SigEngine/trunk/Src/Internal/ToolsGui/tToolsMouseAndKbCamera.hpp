...
namespace Sig
{
	...
	public:
		...
		void fSetOrtho( Gfx::tCamera& cameraData, u32 projectionSetting );
		...
		void fSetHandAdjusting( b32 handAdjust ) { mHandAdjusting = handAdjust; }
		static void fUpdateOrthoLens( Gfx::tCamera& camera );
	private:
