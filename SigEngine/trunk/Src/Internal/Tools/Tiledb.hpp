...
namespace Sig { namespace Tiledml
{
	...
	tools_export b32 fIsTiledmlFile( const tFilePathPtr& path );
	tools_export tFilePathPtr fTiledmlPathToTiledb( const tFilePathPtr& path );
	tools_export tFilePathPtr fTiledbPathToTiledml( const tFilePathPtr& path );
	...
	public:
		...
		static b32 fLoadTiledmls( tGrowableArray< tFile >& loadedFiles );
