...
namespace Sig
{
	...
	public:
		...
		struct tIndexBuffer
		{
			...
			tGrowableArray< tIndexWindow >	mWindows;
		};

		struct tIndexBufferData
		{
			u32							 mNumTris;
			tGrowableArray<tIndexBuffer> mBuffers;
			tIndexBufferData( ) : mNumTris( 0 ) { }
		};
	...
	public:
		...
		///
		/// \brief Add mesh data
		tLoadInPlaceResourcePtr* fAddMeshData( 
			u32 meshCount,
		...
		///
		/// \brief Add mesh data after creating progressive lods
		tLoadInPlaceResourcePtr* fAddProgressiveMeshData( 
