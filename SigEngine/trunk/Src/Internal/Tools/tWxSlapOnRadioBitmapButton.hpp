...
namespace Sig
{
	...
	public:
		...
		inline tWxSlapOnRadioBitmapButton* fGetSelectedButton( ) const { if( mSelected >= 0 && mSelected <= (s32)mButtons.fCount( ) ) return mButtons[ mSelected ]; else return NULL; }
	...
	{
		define_dynamic_cast_base(tWxSlapOnRadioBitmapButton);
