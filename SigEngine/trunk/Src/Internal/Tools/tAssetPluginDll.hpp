...
namespace Sig
{
	...
	public:
		...
		static const char*						fGetReleasePluginExt( );
		static const char*						fGetDebugPluginExt( );
		static const char*						fGetOldPluginExt( );
	...
	public:
		...
		b32									fValid( ) const;
		const std::string &					fErrorString( ) const { return mErrorString; }
	...
	private:
		...
		void fLoadPluginsFromDirectory( const tFilePathPtr& directory );
	};
