...
namespace Sig
{
	...
	public:
		explicit tAINode( const std::string& typeName, const wxColour& titleBarColor, const wxColour& titleTextColor, b32 editable, const wxPoint& topLeft = wxPoint( 0, 0 ) );
		...
		tDAGNodeInput* fAddInput( const std::string& inputName, tDAGNodeOutput::tEdge edge = tDAGNodeOutput::cLeft, const wxColor& inputColor = wxColour( 0x11, 0xee, 0x11 ), const wxString& toolTip = "" );
