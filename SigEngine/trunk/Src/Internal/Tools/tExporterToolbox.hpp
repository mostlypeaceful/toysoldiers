...
namespace Sig
{
	...
	public:
		...
		static const char* fNameStateIndex( ) { return "StateIndex"; } // This is no longer used, but is kept around to support conversion from legacy assets.
		static const char* fNameStateMask( ) { return "StateMask"; }

		static const char* fNameHighLodRatio( ) { return "Lod Ratio High"; }
		static const char* fNameMediumLodRatio( ) { return "Lod Ratio Medium"; }
		static const char* fNameLowLodRatio( ) { return "Lod Ratio Low"; }
		...
		static const char* fNameXparentDepthPrepass( ) { return "TransparentDepthPrepass"; }
