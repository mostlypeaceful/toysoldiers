...
namespace Sig
{
	...
	tDAGNodeOutput::tDAGNodeOutput( const wxString& name, tDAGNode& owner, const wxColour& color, u32 maxConnections, tEdge edge, f32 radius )
		: mOwner( owner )
		, mColor( color )
	...
	tDAGNodeInput::tDAGNodeInput( const wxString& name, tDAGNode& owner, const wxColour& color, u32 maxConnections, tEdge edge, f32 radius )
	...
	tDAGNodeText::tDAGNodeText( const wxString& name, const wxString& value, tDAGNode& owner, b32 hideIfNullText )
		: mOwner( owner )
		, mName( name )
		, mValue( value )
		, mLabelXOffset( 14.f )
	...
	tDAGNode::tDAGNode( const wxString& name, const wxColour& titleBarColor, const wxColour& titleBarTextColor, const wxPoint& topLeft )
		: mOwner( NULL )
		, mName( name )
		, mTopLeft( topLeft )
	...
	void tDAGNode::fSetName( const wxString& name )
	{
		mName = name;
		fComputeDimensions( );
	}

	void tDAGNode::fOnPaint( const wxPoint& topLeftOrigin, const wxSize& clipDims, wxDC& dc, b32 outputsBeforeInputs )
	{
