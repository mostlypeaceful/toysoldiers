...
namespace Sig
{
	...
	private:
		...
		Gfx::tHeightFieldMaterialPtr	mTerrainMaterial;
	...
	public:
		...
		b32 fUpdateGroundCoverDims( u32 id, f32 unitSize, u32 maxUnitSpawns );
	...
	private:
		...
		b32 fUpdateGroundCoverDims( tGroundCoverInternal & cover, f32 unitSize, u32 maxUnitSpawns );
	...
	{
		Gfx::tGeometryBufferSysRam		mSysRamVerts;
		Gfx::tIndexBufferSysRam			mSysRamIndices;
	...
	public:
		...
		inline const Gfx::tGeometryBufferSysRam&	fGetSysRamVerts( ) const { return mSysRamVerts; }
		inline const Gfx::tIndexBufferSysRam&		fGetSysRamIndices( ) const { return mSysRamIndices; }
	...
	private:
		...
		void fAddToSigmlConverter( tHeightFieldMeshEntityDef* entityDefOut, tSigmlConverter& sigmlConverter );

		virtual void fCollectEntities( tEntity& parent, const tEntityCreationFlags& creationFlags ) const { } // TODO it'd be nice if we didn't need to override this
		virtual tHeightFieldRenderVertex* fLockRenderVerts( u32 startVertex = 0, u32 numVerts = ~0 );
		virtual void fUnlockRenderVerts( tHeightFieldRenderVertex* lockedVerts );
		virtual u16* fLockRenderIds( u32 startIndex = 0, u32 numIds = ~0 );
		virtual void fUnlockRenderIds( u16* lockedIds );
