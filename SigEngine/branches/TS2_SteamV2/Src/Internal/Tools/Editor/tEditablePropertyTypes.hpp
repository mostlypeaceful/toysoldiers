...
namespace Sig
{
	...
	public:
		...
		virtual void fCreateGui( wxWindow* parent, const std::string& label );
	...
	public:
		...
		virtual void fCreateGui( wxWindow* parent, const std::string& label )
		{
			...
			{
				mSpinners[ i ] = new tSpinner( this, parent, fIthSpinnerName( label, i ), mMin, mMax, mIncrement, mPrecision );
			...
			if( mAllowDelete )
				fAddRemoveButton( parent, *mSpinners.fBack( ) );
		}
