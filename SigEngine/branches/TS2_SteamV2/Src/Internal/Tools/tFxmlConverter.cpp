...
namespace Sig
{
	...
	b32 tFxmlConverter::fConvertPlatformCommon( )
	{
		...
		if( numConverted == 0 )
		{
			log_warning( 0, "Failed to correctly build any fx objects. Check your materials!" );
			return false;
		}
	...
	b32 tFxmlConverter::fOutput( tFileWriter& ofile, tPlatformId pid )
	{
		...
		tBinaryFileBase::fSetSignature( pid, Rtti::fGetClassId< tFxFile >( ), tFxFile::cVersion );
