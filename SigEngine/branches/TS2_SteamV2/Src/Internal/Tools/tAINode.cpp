...
namespace Sig
{
	...
	tAINode::tAINode( const wxString& typeName, const wxColour& titleBarColor, const wxColour& titleTextColor, b32 editable, const wxPoint& topLeft )
	...
	tDAGNodeInput* tAINode::fAddInput( const wxString& inputName, tDAGNodeOutput::tEdge edge, const wxColor& inputColor, const wxString& toolTip )
	{
