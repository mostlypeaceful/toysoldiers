...
namespace Sig
{
	...
	tShadeNode::tShadeNode( const wxString& titleText, const wxColour& titleBarColor, const wxColour& titleTextColor, b32 editable, const wxPoint& topLeft )
	...
	void tShadeNode::fAddInput( const wxString& inputName, const wxColor& inputColor )
	{
	...
	void tShadeNode::fAddOutput( const wxString& outputName, const wxColor& outputColor )
	{
