...
namespace Sig
{
	...
	{
	public:
		enum tType { cRegularType, cPolledType, cPotentialType, cFirstChanceType, cOnActivateType, cOnSuspendType, cOnCompleteType, cSwitchType, cSequenceType, cTypeCount };
	...
	public:
		...
		static const std::string cWaitForEndPropertiesName;
