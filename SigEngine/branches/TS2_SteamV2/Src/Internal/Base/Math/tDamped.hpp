...
namespace Sig { namespace Math
{
	...
	public:
		...
		void fSetBlends( const t& blendStart, const t& blendEnd ) { mBlendStart = blendStart; mBlendEnd = blendEnd; }
		void fSetBlends( const t& blendStartAndEnd ) { mBlendStart = blendStartAndEnd; mBlendEnd = blendStartAndEnd; }
