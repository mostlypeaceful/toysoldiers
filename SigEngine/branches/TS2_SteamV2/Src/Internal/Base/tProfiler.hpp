...
namespace Sig
{
	...
	public:
		struct tPerfCategory
		{
			...
			tPerfCategory( ) 
				: mNumberOfThreads( 1 ), mTimeMs( 0.f ) { }
			explicit tPerfCategory( const tStringPtr& displayName, const tStringPtr& groupName, u32 numThreads = 1, b32 excludeFromGroupTime = false ) 
				: mDisplayName( displayName ), mGroupName( groupName ), mNumberOfThreads( numThreads ), mTimeMs( 0.f ), mExcludeFromGroupTime( excludeFromGroupTime ) { }
		};
