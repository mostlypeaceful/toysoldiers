...
namespace Sig
{
	...
	public:
		...
		b32 fCreate( 
			...
			const XCONTENT_CROSS_TITLE_DATA & contentData,	// Content data retrieved from a tContentEnumerator
		...
		u32 fUserIndex( ) const { return mUserIndex; }
	...
	private:
		...
		private:
			XCONTENT_CROSS_TITLE_DATA mContentData;
		};
#else
		class tContentOp { };
#endif
