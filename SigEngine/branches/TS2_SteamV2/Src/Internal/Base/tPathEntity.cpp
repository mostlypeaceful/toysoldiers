...
namespace Sig
{
	...
	void tPathEntityDef::fCollectEntities( tEntity& parent, const tEntityCreationFlags& creationFlags ) const
	{
		tPathEntity* entity = NEW tPathEntity( this, mBounds, mObjectToLocal );
	...
	void tPathEntity::fPropagateSkeleton( tAnimatedSkeleton& skeleton )
	{
