...
namespace Sig { namespace Gfx
{
	...
	public:
		...
		f32 mBottom, mTop;
		f32 mZoom;
		tProjectionType mProjectionType;
	public:
		tLens( );
		tLens( f32 nearPlane, f32 farPlane, f32 vpWidth, f32 vpHeight, tProjectionType projType = cProjectionPersp, f32 zoom = 1.f );
		tLens( f32 nearPlane, f32 farPlane, f32 left, f32 right, f32 bottom, f32 top, tProjectionType projType = cProjectionPersp, f32 zoom = 1.f );
		void fConstructProjectionMatrix( Math::tMat4f& projOut );
		void fChangeZoom( f32 newZoom );
	private:
		void fConstructProjectionMatrixPersp( Math::tMat4f& projOut );
		void fConstructProjectionMatrixOrtho( Math::tMat4f& projOut );
		void fConstructProjectionMatrixScreen( Math::tMat4f& projOut );
	};
	...
	public:
		...
		void fChangeProjectionType( tLens::tProjectionType projType );
