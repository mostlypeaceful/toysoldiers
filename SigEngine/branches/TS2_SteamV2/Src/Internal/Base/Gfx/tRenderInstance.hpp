...
namespace Sig { namespace Gfx
{
	...
	/// \see tSpatialEntity for an explanation of the spatial member variables.
	...
	public:
		...
		inline b32 fRequiresXparentBatch( f32 fadeAlpha ) const				{ return mBatch && fRequiresXparentSort( fadeAlpha ) && !mBatch->fBatchData( ).mRenderState->fHasTransparency( ); }
