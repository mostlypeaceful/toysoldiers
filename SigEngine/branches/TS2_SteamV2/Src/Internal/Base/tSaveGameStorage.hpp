...
namespace Sig
{
	...
	class tSaveGameStorageEnumerator
	{
	public:
	...
	class tSaveGameStorageWriter : public tSaveGameStorage
	{
	public:
	...
	class tSaveGameStorageReader : public tSaveGameStorage
	{
	public:
