...
// Device info.
#define XBOX360_DEVICE_DEFERRED_NAME		(L"360 Deferred")
...
#define XBOX360_NO_BUFFERING_BLOCK_SIZE	(2048)	
	...
	)
{
	...
	// block size? It should be a multiple of XBOX360_NO_BUFFERING_BLOCK_SIZE. (check -blocksize argument in the File Packager command line)
	AKASSERT( ( io_transferInfo.uFilePosition % XBOX360_NO_BUFFERING_BLOCK_SIZE ) == 0
...
{
    return XBOX360_NO_BUFFERING_BLOCK_SIZE;
}
    ...
    )
{
	...
	AKPLATFORM::SafeStrCpy( out_deviceDesc.szDeviceName, XBOX360_DEVICE_DEFERRED_NAME, AK_MONITOR_DEVICENAME_MAXLENGTH );
