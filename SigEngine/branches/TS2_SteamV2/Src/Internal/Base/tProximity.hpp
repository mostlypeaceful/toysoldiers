...
namespace Sig
{
	...
	class tProximity : public tRefCounter
	{
	public:
		...
		typedef void (*tPostFilterFunction)( const tEntity& parent, tProximity& proximity, tGrowableArray<tEntityPtr>& entsToPostFilter );
	...
	public:
		...
		b32		fRefreshMT( f32 dt, const tEntity& parent, const Math::tMat3f *explicitXform = NULL );
		...
		tPostFilterFunction	fPostFilterFunction( ) const					{ return mPostFilterFunction; }
		void	fSetPostFilterFunction( tPostFilterFunction postFilterFunc ) { mPostFilterFunction = postFilterFunc; }
