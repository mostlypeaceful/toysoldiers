...
namespace Sig
{
	...
	public:
		...
		b32					fCreate(
								  ...
								  int icon_id=-1, LPSTR cursorResource=NULL,
									int bkgnd=-1,
		...
		void				fDestroy( );
		void				fShow( int width, int height, int x = CW_USEDEFAULT, int y = CW_USEDEFAULT, b32 maximize = false, b32 show = true, b32 fullsreen = false );
		...
		void				fGetPosition( int &x, int &y ) const;
