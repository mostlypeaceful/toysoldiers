...
namespace Sig
{
	...
	private:
		...
		static f32 fRandStateToFloatMinusOneToOne( u32& randState, tRandom* rand );
		static f32 fRandStateToFloatZeroToOne( u32& randState, tRandom* rand );
	...
	public:
		...
		{
			return fRandStateToFloatMinusOneToOne( mState, this );
		}
		...
		{
			return fRandStateToFloatZeroToOne( mState, this );
		}
