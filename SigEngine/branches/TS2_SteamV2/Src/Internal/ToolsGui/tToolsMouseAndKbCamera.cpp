...
namespace Sig
{
	...
	void tToolsMouseAndKbCamera::fSetOrtho( Gfx::tCamera& cameraData, Gfx::tLens::tProjectionType newSetting )
	{
		if( newSetting == Gfx::tLens::cProjectionOrtho )
		{
			mSavedPerspLens = cameraData.fGetLens( );
			cameraData.fChangeProjectionType( Gfx::tLens::cProjectionOrtho );
		}
		else if( newSetting == Gfx::tLens::cProjectionPersp )
		{
