...
namespace Sig
{
	...
	void tModifySelectionAction::fUndo( ) { fMainWindow( ).fGuiApp( ).fSelectionList( ).fReset( mUndoState ); }
	void tModifySelectionAction::fRedo( ) { fMainWindow( ).fGuiApp( ).fSelectionList( ).fReset( mRedoState ); }
