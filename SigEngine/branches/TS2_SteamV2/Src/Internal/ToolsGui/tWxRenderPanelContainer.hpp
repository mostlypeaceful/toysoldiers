...
namespace Sig
{
	...
	protected:
		...
		// gfx stuff (owned by this)
		Gfx::tGeometryBufferVRamAllocatorPtr		mSolidColorGeometryAllocator;
		Gfx::tGeometryBufferVRamAllocatorPtr		mParticleGeomAllocator;
		Gfx::tGeometryBufferVRamAllocatorPtr		mTextGeometryAllocator;
		Gfx::tGeometryBufferVRamAllocatorPtr		mQuadGeometryAllocator;
		Gfx::tGeometryBufferVRamAllocatorPtr		mDecalGeometryAllocator;
		Gfx::tIndexBufferVRamAllocatorPtr			mIndexAllocator;

		Gfx::tMaterialPtr							mSolidColorMaterial;
	...
	public:
		...
		const Gfx::tGeometryBufferVRamAllocatorPtr&		fGetSolidColorGeometryAllocator( ) const { return mSolidColorGeometryAllocator; }
		const Gfx::tGeometryBufferVRamAllocatorPtr&		fGetParticleGeometryAllocator( ) const { return mParticleGeomAllocator; }
		const Gfx::tGeometryBufferVRamAllocatorPtr&		fGetQuadGeometryAllocator( ) const { return mQuadGeometryAllocator; }
		
		const Gfx::tIndexBufferVRamAllocatorPtr&		fGetSolidColorIndexAllocator( ) const { return mIndexAllocator; }
		const Gfx::tIndexBufferVRamAllocatorPtr&		fGetTextIndexAllocator( ) const { return mIndexAllocator; }
		const Gfx::tIndexBufferVRamAllocatorPtr&		fGetQuadIndexAllocator( ) const { return mIndexAllocator; }

		const Gfx::tGeometryBufferVRamAllocatorPtr&		fGetTextGeometryAllocator( ) const { return mTextGeometryAllocator; }
		const Gfx::tMaterialPtr&						fGetSolidColorMaterial( ) const { return mSolidColorMaterial; }
		const tResourcePtr&								fGetSolidColorMaterialFile( ) const { return mSolidColorMaterialFile; }
		const tResourcePtr&								fGetFullBrightMaterialFile( ) const { return mFullBrightMaterialFile; }
		const tResourcePtr&								fGetDefaultFont( ) const { return mDefaultFont; }
