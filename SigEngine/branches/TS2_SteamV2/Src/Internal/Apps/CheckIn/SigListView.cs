// Class from http://blogs.msdn.com/b/hippietim/archive/2006/03/27/562256.aspx
...
namespace CheckIn
{
    class SigListView : ListView
    {
        private bool m_doubleClickDoesCheck = false;  //  maintain the default behavior
