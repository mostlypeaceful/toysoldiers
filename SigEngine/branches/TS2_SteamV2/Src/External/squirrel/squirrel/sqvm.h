...
public:
	...
	bool Call(SQObjectPtr &closure, SQInteger nparams, SQInteger stackbase, SQObjectPtr &outres,SQBool raiseerror, bool *suspend=NULL);
	SQRESULT Suspend();

	void CallDebugHook(SQInteger type,SQInteger forcedline=0,bool *suspend=NULL);
