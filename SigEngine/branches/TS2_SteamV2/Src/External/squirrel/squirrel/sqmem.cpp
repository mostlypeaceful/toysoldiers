...
namespace
{
	void* mallocWrap( SQUnsignedInteger size )
	{
		return ::malloc( size ); 
	}
	void* reallocWrap( void* p, SQUnsignedInteger oldSize, SQUnsignedInteger newSize )
	{
		return ::realloc( p, newSize ); 
	}
	void freeWrap( void* p, SQUnsignedInteger size )
	{
		::free( p ); 
	}
}
