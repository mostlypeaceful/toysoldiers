...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl02_jungleairstrip( ) )
}

class LevelLogic_Challenge_lvl02_jungleairstrip extends GameStandardLevelLogic
{
...
//		wave_01 = AddWaveList( "Wave01" )
	...
	{
		//rank: fighter kills
		if( PlayerKilledTheseUnitsWithOneOfTheseUnits( event, [ UNIT_TYPE_INFANTRY, UNIT_TYPE_VEHICLE, UNIT_TYPE_AIR ], [ UNIT_ID_PLANE_FIGHTER_01, UNIT_ID_PLANE_FIGHTER_02 ] ) )
		{
