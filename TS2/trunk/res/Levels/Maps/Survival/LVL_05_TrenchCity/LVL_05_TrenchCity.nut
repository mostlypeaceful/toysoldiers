...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl05_trentchcity( ) )
}

class LevelLogic_Challenge_lvl05_trentchcity extends GameStandardLevelLogic
{
