...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl03( ) )
}

class LevelLogic_Challenge_lvl03 extends GameStandardLevelLogic
{
	...
	{		
		...
		LevelIntro2P( "CamIntro", "CamIntro_02", null )
	}
	...
	{
		//rank: helo gunship kills
		if( PlayerKilledTheseUnitsWithOneOfTheseUnits( event, [ UNIT_TYPE_INFANTRY, UNIT_TYPE_VEHICLE, UNIT_TYPE_AIR ], [ UNIT_ID_HELO_TRANSPORT_01, UNIT_ID_HELO_TRANSPORT_02 ] ) )
		{
