...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl04_dmz( ) )
}

class LevelLogic_Challenge_lvl04_dmz extends GameStandardLevelLogic
{
	...
	{		
		...
		SetSurvivalWaves( AddWaveList( "WaveList01" ), AddWaveList( "WaveList02" ) )
	...
	{
		//rank: flame 3 kills
		if( PlayerKilledTheseUnitsWithOneOfTheseUnits( event, [ UNIT_TYPE_INFANTRY, UNIT_TYPE_VEHICLE, UNIT_TYPE_AIR ], [ UNIT_ID_TURRET_FLAME_03 ] ) )
		{
