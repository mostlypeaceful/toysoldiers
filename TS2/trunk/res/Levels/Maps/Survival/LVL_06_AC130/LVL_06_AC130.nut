...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl06_ac130( ) )
}

class LevelLogic_Challenge_lvl06_ac130 extends GameStandardLevelLogic
{
	...
	{		
		...
		wave_AC130 = AddWaveList( "WaveListAC130" ) 
		wave_AC130.Activate( )
	...
	{
			GameApp.GetPlayer( 0 ).LockInUnit( "AC130_MG" )
			GameApp.GetPlayer( 1 ).LockInUnit( "AC130_AUTOGUN" )
	}
