...
{
	RegisterLevelLogic( entity, LevelLogic_Campaign_lvl02( ) )
}

class LevelLogic_Campaign_lvl02 extends GameStandardLevelLogic
{
	wave_01 = null
	wave_02 = null
	...
	function OnSpawn( )
	{
		...
		wave_02 = AddWaveList( "PlayerHelo" )
		wave_02.SetLooping( false )
		wave_02.SetMakeSelectableUnits( 1 )
		wave_02.Saveable = 0
		wave_02.DisableAIFire = 1

		LevelIntro2P( "nis_intro_campath", "nis_intro_campath", null, true, false )
		
		// Point Man: Earn a 80x combo with a Medium Tank.
		// Decoration 2: Destroy all APCs before they unload their cargo
		// Challenge: Machine Gun III: Kills
		InitDecoration( 0, null, function( event ) { return PlayerKilledWithOneOfTheseUnits( event, -1, [ UNIT_ID_TANK_MEDIUM_01 ] ) && event.Combo == 80 }.bindenv( this ) )
		InitDecoration( 1, 5, PlayerKilledAnApcBeforeItUnloaded.bindenv( this ) )
		InitChallenge( function( event ) { return PlayerKilledTheseUnitsWithOneOfTheseUnits( event, [ UNIT_TYPE_INFANTRY, UNIT_TYPE_VEHICLE, UNIT_TYPE_AIR ], [ UNIT_ID_TURRET_MG_03 ] ) }.bindenv( this ) )
	...
	function PlayerKilledAnApcBeforeItUnloaded( event )
	{
		if( PlayerKilledParticularUnitWithOneOfTheseUnits( event, [ UNIT_ID_APC_MG_01, UNIT_ID_APC_AT_01, UNIT_ID_APC_ARTY_01, UNIT_ID_APC_AA_01, UNIT_ID_APC_IFV_01 ], -1 ) )
		{
			if( event.Entity.Logic.HasEverDroppedCargo == 0 )
				return true
		}
