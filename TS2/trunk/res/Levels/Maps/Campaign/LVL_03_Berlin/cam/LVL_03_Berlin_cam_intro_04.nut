...
@[TOTAL_TIME] { "Total Time", 19.0, [ 0.0:999999999.0 ], "TODO COMMENT" }
@[EASE_IN] { "Ease In", 1.5, [ 0.0:1.0 ], "TODO COMMENT" }
@[EASE_OUT] { "Ease Out", 3.1, [ 0.0:1.0 ], "TODO COMMENT" }
@[GAME_BLEND_IN] { "Game Blend In", 0.5, [ 0.0:999999999.0 ], "TODO COMMENT" }
...
sigexport function EntityOnCreate( entity )
{
	...
	params.LookAtTarget = "nis_intro_focalpoint_eastgate"
