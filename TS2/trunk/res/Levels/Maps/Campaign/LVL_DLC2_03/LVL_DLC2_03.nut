...
{
	RegisterLevelLogic( entity, LevelLogic_Campaign_dlc2_03( ) )
}

class LevelLogic_Campaign_dlc2_03 extends GameStandardLevelLogic
{
	wave_01 	= null
	wave_02 	= null
	wave_boss 	= null
	...
	function OnSpawn( )
	{
		...
		// Imperial Demands: Destroy 150 infantry with a Naval Helo.
		// Empirical Results: Use the Orbital Laser.
		// Challenge: Artillery III: Kills
		InitDecoration( 0, 150, function( event ) { return PlayerKilledTheseUnitsWithOneOfTheseUnits( event, [ UNIT_TYPE_INFANTRY ], [ UNIT_ID_HELO_SUPER_HORMONE ] ) }.bindenv( this ) )
		InitDecoration( 1, null, function( event ) { return event.EventID == TUTORIAL_EVENT_BARRAGE_ACTIVATED && event.WeaponID == "BARRAGE_LAZER" }.bindenv( this ) )
