...
@[TOTAL_TIME] { "Total Time", 13.0, [ 0.0:999999999.0 ], "TODO COMMENT" }
@[EASE_IN] { "Ease In", 0.2, [ 0.0:1.0 ], "TODO COMMENT" }
@[EASE_OUT] { "Ease Out", 0.1, [ 0.0:1.0 ], "TODO COMMENT" }
@[GAME_BLEND_IN] { "Game Blend In", 3.0, [ 0.0:999999999.0 ], "TODO COMMENT" }
...
sigexport function EntityOnCreate( entity )
{
	...
	params.LookAtTarget = "nis_intro_focalpoint_eastback"
