...
{
	RegisterLevelLogic( entity, LevelLogic_Challenge_lvl01_gatlinggun( ) )
}

class LevelLogic_Challenge_lvl01_gatlinggun extends GameStandardLevelLogic
{
	wave_01 = null
	wave_02 = null
	wave_03 = null
	...
	{
		::GameApp.GetPlayer( 0 ).LockInUnit( "turret" )
	...
	function ConfigureMiniGame( )
	{
		...
		miniGameBeginLocKey = "beginMiniGame1"
	...
	{
		if( PlayerKilledWithOneOfTheseWeapons( event, -1, [ "TURRET_GATLINGGUN_ALT" ] ) )
		{
