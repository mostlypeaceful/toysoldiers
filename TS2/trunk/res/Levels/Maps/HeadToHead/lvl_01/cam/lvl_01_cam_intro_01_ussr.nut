...
@[TOTAL_TIME] { "Total Time", 10, [ 0.0:999999999.0 ], "TODO COMMENT" }
@[EASE_IN] { "Ease In", 0.5, [ 0.0:1.0 ], "TODO COMMENT" }
@[EASE_OUT] { "Ease Out", 0.3, [ 0.0:1.0 ], "TODO COMMENT" }
@[GAME_BLEND_IN] { "Game Blen In", 1, [ 0.0:999999999.0 ], "TODO COMMENT" }
...
sigexport function EntityOnCreate( entity )
{
	...
	params.LookAtTarget = "nis_intro_focal_target_01_ussr"
