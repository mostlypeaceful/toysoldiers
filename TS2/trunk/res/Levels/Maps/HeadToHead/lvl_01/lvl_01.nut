...
{
	RegisterLevelLogic( entity, LevelLogic_lvl_01( ) ) // RENAME to current level
}

class LevelLogic_lvl_01 extends GameStandardLevelLogic // RENAME to current level
{
	wave_01 = null
	wave_02 = null
	...
	function OnSpawn( )
	{
		...
		AddOffensiveWave( offensiveWave_HeavyTank2Usa )
		...
		AddOffensiveWave( offensiveWave_HeavyTank2Ussr )
	}
