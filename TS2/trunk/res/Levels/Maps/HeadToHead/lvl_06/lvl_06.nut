...
{
	RegisterLevelLogic( entity, LevelLogic_HeadToHead_lvl06( ) )
}

class LevelLogic_HeadToHead_lvl06 extends GameStandardLevelLogic
{
	...
	function OnSpawn( )
	{
		...
		AddOffensiveWave( offensiveWave_MediumTankUsa )
		...
		AddOffensiveWave( offensiveWave_MediumTankUssr )
