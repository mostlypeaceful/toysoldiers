...
{
	entity.Logic = USSR_Plane_Bomber_Barrage( )
}

class USSR_Plane_Bomber_Barrage extends AirborneVehicleLogic
{
	constructor( )
	{
	...
	function DebugTypeName( )
		return "USSR_Plane_Bomber_Barrage"
...
// Weapons: USSR Bear Bomb
		...
		gunBank.AddWeapon( "USSR_BEAR_BOMB_BARRAGE", "" )
