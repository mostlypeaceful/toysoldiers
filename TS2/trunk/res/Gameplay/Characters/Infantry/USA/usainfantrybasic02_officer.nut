...
{
	entity.Logic = USA_50s_Infantry_Officer_02( )
}
...
class USA_50s_Infantry_Officer_02 extends InfantryLogic
{
	constructor( )
	{
	...
	function GetHead( )
	 {
		 local heads = {}
		 heads[0] <- "Art/Characters/Blue/usa_head_6.mshml"
		 heads[1] <- "Art/Characters/Blue/usa_head_4.mshml"
