...
{
	entity.Logic = Korea_Infantry_Basic_01( )
}
...
class Korea_Infantry_Basic_01 extends InfantryLogic
{
	constructor( )
	{
		InfantryLogic.constructor( )
		SoldierLogic.SetAlternateDebrisMesh( "Art/Characters/Red/korean_infantry_debris.sigml" )
	}
	
	function DebugTypeName( )
		return "Korea_Infantry_Basic_01"
	...
	function GetHelmet( ) 
	{
		 ...
		 helms[1] <- "Art/Characters/Red/korean_cap.mshml"
		 ...
		 helms[8] <- "Art/Characters/Red/chinese_helmet.mshml"
