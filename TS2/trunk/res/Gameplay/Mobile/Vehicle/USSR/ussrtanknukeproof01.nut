...
{
	entity.Logic = USSR_Tank_Nukeproof_01( )
}

class USSR_Tank_Nukeproof_01 extends ScriptWheeledVehicleLogic
{
	constructor( )
	{
...
//		gunE.Logic.Animatable.ExecuteMotionState( "Idle", { Weapon = gun } )
		...
		cannonE.Logic.Animatable.MotionMap = USSR_Tank_Nukeproof_01_GunMoMap( )
...
class USSR_Tank_Nukeproof_01_GunMoMap extends MobileTurretMoMap
{
