...
sigimport "Anims/Vehicles/blue/bomber_b52d/bomber_b52d.anipk"

class USAPlaneBomber01MoMap extends AirborneMotionMap
{	
	function SetAnimPack( )
	{
		animPack = GetAnimPack( "Anims/Vehicles/blue/bomber_b52d/bomber_b52d.anipk" )
	}
