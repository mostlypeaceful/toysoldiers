...
namespace Sig { namespace GameFlags
{
	...
	static const u32 cEVENT_INPUT_CONFIG_CHANGED = 43u;
	static const u32 cEVENT_REST_BEGIN = 44u;
	static const u32 cEVENT_REST_END = 45u;
	static const u32 cEVENT_DEPLOY_BEGIN = 46u;
	static const u32 cEVENT_FORCE_FIRE = 47u;
	static const u32 cEVENT_ROBOT_ATTACK = 48u;
	static const u32 cEVENT_COUNT = 49;

	const tStringPtr& fGameEventToString( u32 eventValue );			// returns "GAME_EVENT_VALUE_NAME"
	u32 fGameEventToValue( const tStringPtr& name );				// takes input like GAME_EVENT_VALUE_NAME
	u32 fGameEventValueStringToEnum( const tStringPtr& name );		// takes input like VALUE_NAME

	// AI Flags...

	static const u32 cAIFLAG_COUNT = 0;
	const tStringPtr& fAIFlagToString( u32 eventValue );      // returns "AIFLAG_VALUE_NAME"
	const tStringPtr& fAIFlagToValueString( u32 eventValue );      // returns "VALUE_NAME"
	...
	static const u32 cENUM_GAME_CONTROLS = 60u;
	static const u32 cENUM_GAMECONTROLLER_MODE = 61u;
	static const u32 cENUM_COUNT = 57;
	...
	enum tUNIT_ID
	{
		...
		cUNIT_ID_BOSS_ZEPPELIN = 134u,
		cUNIT_ID_SNIPER_TOWER = 135u,
		cUNIT_ID_BOSS_ZEPPELIN_ENGINE = 136u,
		cUNIT_ID_BOSS_UBER = 137u,
		cUNIT_ID_BOSS_RAILGUN = 138u,
		cUNIT_ID_RAIL_TRANSPORT = 139u,
		cUNIT_ID_COUNT = 140,
	};
	...
	enum tAUDIO_TYPE_ID
	{
		...
		cAUDIO_TYPE_ID_TS1_VEHICLE_BALLOON = 76u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_BOMBER = 77u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_FIRETRUCK = 78u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_MUSTANG = 79u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_SPACETANK = 80u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_TANK_ARMOREDCAR = 81u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_TANK_AV7 = 82u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_TANK_PANZER = 83u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_TANK_WAGON = 84u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_TRIPLANE = 85u,
		cAUDIO_TYPE_ID_TS1_VEHICLE_ZEPPELIN = 86u,
		cAUDIO_TYPE_ID_COUNT = 87,
	};
	...
	enum tACHIEVEMENTS
	{
		...
		cACHIEVEMENTS_TS1_FLYING_PIG = 26u,
		cACHIEVEMENTS_TS1_COFFIN_NAILS = 27u,
		cACHIEVEMENTS_TS1_THROW_A_SEVEN = 28u,
		cACHIEVEMENTS_TS1_BRASS_HAT = 29u,
		cACHIEVEMENTS_TS1_LAND_SHIP = 30u,
		cACHIEVEMENTS_TS1_MR_ROBOTO = 31u,
		cACHIEVEMENTS_COUNT = 32,
	};
	...
	enum tKILL_FLAG
	{
		...
		cKILL_FLAG_PRONE = 5u,
		cKILL_FLAG_PLAYER_INFLUENCED = 6u,
		cKILL_FLAG_COUNT = 7,
	};
	...
	enum tGAME_CONTROLS
	{
		cGAME_CONTROLS_MENU_ACCEPT = 0u,
		cGAME_CONTROLS_MENU_CANCEL = 1u,
		cGAME_CONTROLS_MENU_GAMERCARD = 2u,
		cGAME_CONTROLS_MENU_PAUSE = 3u,
		cGAME_CONTROLS_MENU_REWIND = 4u,
		cGAME_CONTROLS_MENU_UP = 5u,
		cGAME_CONTROLS_MENU_DOWN = 6u,
		cGAME_CONTROLS_MENU_LEFT = 7u,
		cGAME_CONTROLS_MENU_RIGHT = 8u,
		cGAME_CONTROLS_MENU_CYCLE_LEADERBOARD_FILTER = 9u,
		cGAME_CONTROLS_MENU_SHOW_INVITE_UI = 10u,
		cGAME_CONTROLS_MENU_SHOW_LEADERBOARDS = 11u,
		cGAME_CONTROLS_MENU_PREVIOUS_PAGE = 12u,
		cGAME_CONTROLS_MENU_NEXT_PAGE = 13u,
		cGAME_CONTROLS_MENU_SHOW_MULTIPLAYER_CONTROLS = 14u,
		cGAME_CONTROLS_SELECT = 15u,
		cGAME_CONTROLS_CANCEL = 16u,
		cGAME_CONTROLS_PLACEMENT_MENU = 17u,
		cGAME_CONTROLS_LAUNCH_WAVE = 18u,
		cGAME_CONTROLS_LAUNCH_BARRAGE = 19u,
		cGAME_CONTROLS_CAMERA_CYCLE = 20u,
		cGAME_CONTROLS_CAMERA_CENTER = 21u,
		cGAME_CONTROLS_CAMERA_SPEED = 22u,
		cGAME_CONTROLS_CAMERA_FOCUS_EVENT = 23u,
		cGAME_CONTROLS_JUMP = 24u,
		cGAME_CONTROLS_MELEE = 25u,
		cGAME_CONTROLS_ARTILLERY_ROTATE_LEFT = 26u,
		cGAME_CONTROLS_ARTILLERY_ROTATE_RIGHT = 27u,
		cGAME_CONTROLS_ENTER_EXIT_UNIT = 28u,
		cGAME_CONTROLS_ACCELERATE = 29u,
		cGAME_CONTROLS_DECCELERATE = 30u,
		cGAME_CONTROLS_BOOST = 31u,
		cGAME_CONTROLS_HANDBRAKE = 32u,
		cGAME_CONTROLS_DECREASE_ALTITUDE = 33u,
		cGAME_CONTROLS_INCREASE_ALTITUDE = 34u,
		cGAME_CONTROLS_TRIGGER_PRIMARY = 35u,
		cGAME_CONTROLS_TRIGGER_SECONDARY = 36u,
		cGAME_CONTROLS_UNIT_QUICKSWITCH_FORWARD = 37u,
		cGAME_CONTROLS_UNIT_QUICKSWITCH_BEHIND = 38u,
		cGAME_CONTROLS_UNIT_QUICKSWITCH_LEFT = 39u,
		cGAME_CONTROLS_UNIT_QUICKSWITCH_RIGHT = 40u,
		cGAME_CONTROLS_QUICK_USE = 41u,
		cGAME_CONTROLS_QUICK_SELL = 42u,
		cGAME_CONTROLS_QUICK_UPGRADE = 43u,
		cGAME_CONTROLS_QUICK_REPAIR = 44u,
		cGAME_CONTROLS_MOVE_LEFT = 45u,
		cGAME_CONTROLS_MOVE_RIGHT = 46u,
		cGAME_CONTROLS_MOVE_UP = 47u,
		cGAME_CONTROLS_MOVE_DOWN = 48u,
		cGAME_CONTROLS_MOVE_MINMAG = 49u,
		cGAME_CONTROLS_MOVE_MAXMAG = 50u,
		cGAME_CONTROLS_AIM_MINMAG = 51u,
		cGAME_CONTROLS_AIM_MAXMAG = 52u,
		cGAME_CONTROLS_AIM_LEFT = 53u,
		cGAME_CONTROLS_AIM_RIGHT = 54u,
		cGAME_CONTROLS_AIM_UP = 55u,
		cGAME_CONTROLS_AIM_DOWN = 56u,
		cGAME_CONTROLS_BARBED_WIRE = 57u,
		cGAME_CONTROLS_MENU_DROP_PLAYER_2 = 58u,
		cGAME_CONTROLS_CAMERA_MOVE_IN = 59u,
		cGAME_CONTROLS_CAMERA_MOVE_OUT = 60u,
		cGAME_CONTROLS_COUNT = 61,
	};
	const tStringPtr& fGAME_CONTROLSEnumToString( u32 enumValue );      // returns "GAME_CONTROLS_VALUE_NAME"
	const tStringPtr& fGAME_CONTROLSEnumToValueString( u32 enumValue ); // returns "VALUE_NAME"
	...
	enum tGAMECONTROLLER_MODE
	{
		cGAMECONTROLLER_MODE_KEYBOARDMOUSE = 0u,
		cGAMECONTROLLER_MODE_GAMEPAD = 1u,
		cGAMECONTROLLER_MODE_COUNT = 2,
	};
	const tStringPtr& fGAMECONTROLLER_MODEEnumToString( u32 enumValue );      // returns "GAMECONTROLLER_MODE_VALUE_NAME"
	const tStringPtr& fGAMECONTROLLER_MODEEnumToValueString( u32 enumValue ); // returns "VALUE_NAME"
