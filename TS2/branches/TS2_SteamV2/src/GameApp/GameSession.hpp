...
{
	#define cMAX_LEVEL_COUNT 50
	#define cCAMPAIGN_LEVEL_COUNT 48 //All TS1 campaign levels (including DLC packs)
	#define cH2H_LEVEL_COUNT 15
	#define cSURVIVAL_LEVEL_COUNT 9
	...
	const tStringPtr& fAchievementIdToValueString( u32 id );
#endif
