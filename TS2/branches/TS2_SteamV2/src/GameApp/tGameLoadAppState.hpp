...
namespace Sig
{
	...
	private:
		...
		void fAddVersusWaveListUnitsToLoadListByCountry( u32 country );
		void fAddVersusUnitGeneratorsToLoadList( );
		void fAddVersusUnitGeneratorsToLoadListByCountry( u32 country );
	private:
		b32 mAllowLoad;
		b32 mAllowSpawn;
