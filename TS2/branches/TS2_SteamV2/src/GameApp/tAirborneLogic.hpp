...
namespace Sig
{
	...
	public:
		...
		void fSetSpecialMoveInputDisabled( b32 disable ) { mSpecialMoveInputDisabled = disable; }
		b32 fSpecialMoveInputDisabled( ) const { return mSpecialMoveInputDisabled; }
