...
namespace Sig
{
	...
	private:
		...
		b32 mDeployed;
	public:
		void fSetDamageParent( b32 damageParent ) { mDamageParent = damageParent; }
		b32 fGetDamageParent( ) { return mDamageParent; }
		void fSetDeployed( b32 deployed ) { mDeployed = deployed; }
		b32 fGetDeployed( ) { return mDeployed; }
	private:
